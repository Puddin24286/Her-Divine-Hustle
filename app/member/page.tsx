      ...
      <div className="max-w-4xl mx-auto text-center space-y-12">
        <div className="space-y-6">
          ...
          <p className="text-xl md:text-2xl text-off-white/70 font-body max-w-2xl mx-auto leading-relaxed">
            Return to your work.<br />
            Continue where you left off.
          </p>
        </div>
        <div className="space-y-6">
          <Link href="/" className="inline-block px-10 py-5 bg-gold text-obsidian font-bold rounded-full uppercase tracking-[0.2em] text-[10px] hover:bg-white hover:scale-105 transition-all duration-300 shadow-lg shadow-gold/10">
            Continue
          </Link>
        </div>
      </div>
